...
if __name__ == '__main__':
    ...
    image_path = "E:/hw_test_dataset_B/p76/p76_164740_0032.jpg"
    ...
    txt_path = os.path.join(f"test_hw/pred_PoG/single", os.path.basename(image_path).replace(".jpg", ".txt"))
    ...
    images = []
    image_paths = []
    participation_dir = os.path.dirname(image_path)
    if os.path.isdir(participation_dir):
        ...
        main(image_path, txt_path, face_3D_generic_model, face_model_ratio, camera_matrix, camera_distortion)